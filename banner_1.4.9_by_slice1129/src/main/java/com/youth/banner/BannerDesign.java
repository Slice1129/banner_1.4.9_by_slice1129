...
public class BannerDesign extends FrameLayout implements OnPageChangeListener {
    ...
    public BannerDesign(Context context) {
        this(context, null);
    }

    public BannerDesign(Context context, AttributeSet attrs) {
    ...
    public BannerDesign setStartIndex(int startIndex) {
        this.startIndex = startIndex;
        return this;
    }

    public BannerDesign(Context context, AttributeSet attrs, int defStyle) {
    ...
    public BannerDesign isAutoPlay(boolean isAutoPlay) {
        this.isAutoPlay = isAutoPlay;
        return this;
    }

    public BannerDesign setImageLoader(ImageLoaderInterface imageLoader) {
        this.imageLoader = imageLoader;
        return this;
    }

    public BannerDesign setDelayTime(int delayTime) {
        this.delayTime = delayTime;
        return this;
    }

    public BannerDesign setIndicatorGravity(int type) {
        switch (type) {
    ...
    public BannerDesign setBannerAnimation(Class<? extends PageTransformer> transformer) {
        try {
     ...
     * @return Banner
     */
    public BannerDesign setOffscreenPageLimit(int limit) {
        if (viewPager != null) {
     ...
     * @return Banner
     */
    public BannerDesign setPageTransformer(boolean reverseDrawingOrder, PageTransformer transformer) {
        viewPager.setPageTransformer(reverseDrawingOrder, transformer);
        return this;
    }

    public BannerDesign setBannerTitles(List<String> titles) {
        this.titles = titles;
        return this;
    }

    public BannerDesign setBannerStyle(int bannerStyle) {
        this.bannerStyle = bannerStyle;
        return this;
    }

    public BannerDesign setViewPagerIsScroll(boolean isScroll) {
        this.isScroll = isScroll;
        return this;
    }

    public BannerDesign setImages(List<?> imageUrls) {
    ...
    /**
     * @Description: 原作者直接引用地址，clear就没了
     * @author Slice1129
     * @date 2017-06-20 17:47
     */
    public void update(List<?> updatedImageUrls) {
        ArrayList<?> imageUrlsClone = (ArrayList<?>) ((ArrayList<?>) updatedImageUrls).clone();
        this.imageUrls.clear();
        this.imageUrls.addAll(imageUrlsClone);
        this.count = this.imageUrls.size();
        start();
    }
    ...
    private void setData() {
        currentItem = startIndex;//currentItem = 1;
        if (adapter == null) {
        ...
        viewPager.setCurrentItem(startIndex);//viewPager.setCurrentItem(1);
        if (gravity != -1)
...
//        Log.i(tag, ev.getAction() + "--" + isAutoPlay);
    ...
    public int toRealPosition(int position) {
        Log.e("FUCK", "COUNT=" + count + "pos=" + position);
        ...
        switch (state) {
            case 0://No operation
                if (currentItem == 0) {
                    ...
                    Log.e("FUCK", "换听No operation");
                    //viewPager.setCurrentItem(1, false);//不注释，会出现黑屏，例如5/5滑动到1/5时
                }
                break;
    ...
    @Deprecated
    public BannerDesign setOnBannerClickListener(OnBannerClickListener listener) {
     ...
     * @return
     */
    public BannerDesign setOnBannerListener(OnBannerListener listener) {
